...
export const ANCHOR_BACK = 3;          // tip - 3 (same as site)
export const ANCHOR_REFRESH = 150;       // rebuild job before window expires
export const ANCHOR_MAX_SEND = 240;      // drop if tip-anchor > this; on-chain ANCHOR_WINDOW=250
